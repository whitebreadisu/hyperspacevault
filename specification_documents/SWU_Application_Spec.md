...
### 5.5 Unified Cards view — one list, auth-conditional (BL-56)
...
- **Clearing:** the amber ✕ and the panel's Collection-section chip clear only the base-set dimension; **Reset All Filters clears everything** (FilterState + base sets, staying active when only the latter exist).
